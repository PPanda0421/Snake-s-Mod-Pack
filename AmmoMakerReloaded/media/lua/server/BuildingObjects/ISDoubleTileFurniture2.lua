...
ISDoubleTileFurniture2 = ISBuildingObject:derive("ISDoubleTileFurniture2");

--************************************************************************--
--** ISDoubleTileFurniture2:new
--**
--************************************************************************--
function ISDoubleTileFurniture2:create(x, y, z, north, sprite)
...
function ISDoubleTileFurniture2:walkTo(x, y, z)
...
function ISDoubleTileFurniture2:setInfo(square, north, sprite)
...
function ISDoubleTileFurniture2:removeFromGround(square)
...
function ISDoubleTileFurniture2:new(name, sprite1, sprite2, northSprite1, northSprite2)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISDoubleTileFurniture2:getHealth()
	return 200 + buildUtil.getWoodHealth(self);
end

function ISDoubleTileFurniture2:render(x, y, z, square)
...
function ISDoubleTileFurniture2:isValid(square)
...
function ISDoubleTileFurniture2:getSquare2Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISDoubleTileFurniture2:getSquare2(square, north)
