...
farming_vegetableconf.getObjectName = function(plant)
	...
	elseif plant.nbOfGrow == 6 then
		if plant.typeOfSeed == "Lemon" or plant.typeOfSeed == "Orange" or plant.typeOfSeed == "Apple" or plant.typeOfSeed == "Pear" or plant.typeOfSeed == "Peach" or plant.typeOfSeed == "Banana" or plant.typeOfSeed == "Cherry" or plant.typeOfSeed == "Lime" or plant.typeOfSeed == "Avocado" then
			return getText("Farming_Ready_for_Harvest") .. " " .. getText("Farming_" ..plant.typeOfSeed);
		else
