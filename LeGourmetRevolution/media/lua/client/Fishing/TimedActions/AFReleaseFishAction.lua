...
function AFReleaseFishAction:perform()
	...
	if _primary ~= nil then
		...
		local xp = 0;
		if _primary:getType() == "Palometa" or _primary:getType() == "Piranha" or _primary:getType() == "Dentudo" or _primary:getType() == "Anguila" or _primary:getType() == "Crab" or _primary:getType() == "BaitFish" or _primary:getType() == "Crappie" or _primary:getType() == "Panfish" then
			xp = 1;
