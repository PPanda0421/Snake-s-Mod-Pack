...
LGISBuildMenu.doBuildMenu = function(player, context, worldobjects, test, square, subMenu)
	...
	tooltip = LGISBuildMenu.canBuildDoor(5,4,1,2,"NONE",3, CaneFenceDoorOption, player);
	tooltip:setName(_name);
	...
	tooltip = LGISBuildMenu.canBuildDoor(10,10,1,2,"NONE",3, NewDoorOption, player);
	tooltip:setName(_name);
...
LGISBuildMenu.onBuildNewDoor = function(worldobjects, square, sprite, player)
	...
	door.modData["need:Base.SugarcaneDry"] = "10";
