...
function ISRepairlightbar:start()
	self.item:setJobType(getText("IGUI_Repairlightbar"))
...
function ISRepairlightbar:perform()
	...
	sendClientCommand(self.character, 'vehicletmmod', 'repairlightbar', args)
--[[
...
function ISRepairlightbar:new(character, part, item, time)
	local o = {}
	setmetatable(o, self)
	self.__index = self
	...
	o.item = item
	o.maxTime = time
	o.jobType = getText("IGUI_Repairlightbar")
	return o
end
